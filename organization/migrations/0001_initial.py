    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mother_organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='child_organizations', to='organization.organization')),
            ],
            options={
                'abstract': False,
            },
